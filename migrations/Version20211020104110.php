 ...
 */
final class Version20211020104110 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Creating booking table';
    }

    public function up(Schema $schema): void
    {

        $this->addSql('CREATE TABLE booking (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, event_id INT NOT NULL, serial VARCHAR(255) NOT NULL, seat INT NOT NULL, INDEX IDX_E00CEDDEA76ED395 (user_id), INDEX IDX_E00CEDDE71F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
